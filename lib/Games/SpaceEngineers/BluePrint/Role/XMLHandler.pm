...
our $VERSION = '0.07';
##~ DIGEST : 1861839ca3a689f45d734ca5fdb740da
...
sub render_xml {
    ...
    my ( $self, $xml_obj ) = @_;
    XML::LibXML::PrettyPrint->new( indent_string => '', new_line => '' )
      ->pretty_print($xml_obj);
...
sub render_in_template {
    ...
    my ( $self, $p ) = @_;
    confess "Can't do anything without a grid_string parameter"
      unless $p->{grid_string};
    my $ep = { %{$p} };
